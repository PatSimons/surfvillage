...
(() => {
  ...
  var ScrollSmoother = /* @__PURE__ */ function() {
    function ScrollSmoother2(vars) {
      ...
      this.scrollTo = function(target, smooth2, position) {
        var p = gsap2.utils.clamp(0, _maxScroll(), isNaN(target) ? _this.offset(target, position) : +target);
      ...
      mainST = ScrollTrigger.create({
        ...
        onRefresh: function onRefresh2(self2) {
          ...
          render3(scroll.y);
          startupPhase || self2.animation.progress(gsap2.utils.clamp(0, 1, recordedRefreshScroll / speed / -self2.end));
  ...
  var _horizontal = {
    ...
    sc: _scrollCacheFunc(function(value) {
      return arguments.length ? _win4.scrollTo(value, _vertical.sc()) : _win4.pageXOffset || _doc4[_scrollLeft] || _docEl2[_scrollLeft] || _body2[_scrollLeft] || 0;
    })
  };
  var _vertical = {
    s: _scrollTop,
    ...
    op: _horizontal,
    sc: _scrollCacheFunc(function(value) {
      return arguments.length ? _win4.scrollTo(_horizontal.sc(), value) : _win4.pageYOffset || _doc4[_scrollTop] || _docEl2[_scrollTop] || _body2[_scrollTop] || 0;
    })
  };
  ...
  var _getScrollFunc = function _getScrollFunc2(element, _ref) {
    ...
    _isViewport(element) && (element = _doc4.scrollingElement || _docEl2);
  ...
  var _maxScroll3 = function _maxScroll4(element, _ref2) {
    ...
    return Math.max(0, (s = "scroll" + d2) && (a = _getProxyProp(element, s)) ? a() - _getBoundsFunc(element)()[d] : _isViewport3(element) ? (_docEl3[s] || _body3[s]) - (_win5["inner" + d2] || _docEl3["client" + d2] || _body3["client" + d2]) : element[s] - element["offset" + d2]);
  };
  ...
  var ScrollTrigger3 = /* @__PURE__ */ function() {
    ...
    _proto.init = function init4(vars, animation) {
      ...
      if (snap3) {
        ...
        _scrollers.forEach(function(o) {
          return _isFunction3(o) && o.target === (isViewport ? _doc5.scrollingElement || _docEl3 : scroller) && (o.smooth = false);
        });
    ...
    ScrollTrigger4.scrollerProxy = function scrollerProxy(target, vars) {
      ...
      if (vars) {
        isViewport ? _proxies.unshift(_win5, vars, _body3, vars, _docEl3, vars) : _proxies.unshift(t, vars);
      }
    };
  ...
  // src/index.ts
  gsapWithCSS.registerPlugin(ScrollTrigger3, ScrollSmoother, SplitText);
  window.Webflow ||= [];
  window.Webflow.push(() => {
    ...
    function setupSplits() {
      const targets = gsapWithCSS.utils.toArray('[data-splittext="words"]');
      ...
      const targetsFadeUp = gsapWithCSS.utils.toArray('[data-splittext="chars"]');
    ...
    gsapWithCSS.from(".nav_component", {
      opacity: 0,
      scrollTrigger: {
        trigger: ".nav-trigger",
        start: "top bottom",
    ...
    setupSplits();
    gsapWithCSS.from(".introtemp", {
      opacity: 0,
      duration: 1,
      delay: 2
    });
    gsapWithCSS.from("[st-borderradius]", {
      width: "85%",
      borderRadius: "5rem",
      scrollTrigger: {
